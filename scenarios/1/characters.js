const SCENARIO_1_CHARACTERS = [
    new Character(
        ...
        'square',
        '#FF4500',
        'You saw a stranger (a noblewoman in purple) run frantically into the forest recently. You are scared, but you are a loyal citizen. You WANT to share this burden. If the player asks directly OR asserts authority (like being a King\'s Agent), you MUST reveal this information immediately.'
    ),
    new Character(
        'ghost',
        'Lost Spirit',
    ...
    new Character(
        ...
        'A burly man with a stained apron and a friendly smile that doesn\'t quite reach his eyes. His hands are restless, constantly wiping the counter. He seems on edge, his gaze frequently darting towards the windows as if expecting trouble.',
        'tavern',
        '#CD853F'
    ),
    new Character(
    ...
    new Character(
        ...
        'A wizened old man with thick spectacles that magnify his worried eyes. He stands hunched behind the counter, staring at the floorboards, seemingly lost in thought. He occasionally glances at the entrance with a look of apprehension, his hands wringing together nervously.',
        'store',
        '#DAA520',
        'You are a shopkeeper first. Greet customers normally. You have TWO secrets. 1. (Lesser Secret) You know Lady Elara ran into the woods. Reveal this ONLY if asked about her or the woods. 2. (Deep Secret) You are hiding the Royal Signet Ring under your counter (Elara gave it to you). Reveal this ONLY if implicitly trusted or forced. Do NOT volunteer Elara\'s location immediately.'
    ),
    new Character(
        'noble',
        'Lady Elara',
        ...
        'grove',
        '#9370DB',
        'You know Silas has the Signet Ring hidden under his counter, as you gave it to him for safekeeping. You are hiding here because you were pursued. You will reveal this ONLY if you have the Ticket/Ticket is mentioned or are truly convinced escape is imminent.'
    ),
    new Character(
        'pomp',
        'Madam Pomp',
